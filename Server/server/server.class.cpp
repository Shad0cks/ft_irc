...
void Server::createChannel(std::string name, Client * owner, std::string mod)
{
	...
	this->sendMessage(owner->socketFD, "324 " + owner->getnickname() + " " + name + " " + mod);
...
void Server::joinChannel(std::string name, Client * user, std::string mod)
{
